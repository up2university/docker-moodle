...
SELECT '${CERNBOX_REPO_NAME}', (SELECT id FROM `mdl_repository` WHERE mdl_repository.type = '${CERNBOX_REPOSITORY_TYPE}' LIMIT 1),0,1,NULL,NULL,1516380035,1516380035,0

...
...skipping...
//
// You can specify db, selenium wd_host etc. for behat parallel run by setting f
ollowing variable.
// Example:
...
//
// You can override default Moodle configuration for Behat and add your own
// params; here you can add more profiles, use different Mink drivers than Selen
ium...
// These params would be merged with the default Moodle behat.yml, giving priori
ty
// to the ones specified here. The array format is YAML, following the Behat
// params hierarchy. More info: http://docs.behat.org/guides/7.config.html
// Example:
...
//                   'selenium2' => array(
// it will be used instead of $CFG->wwwroot/course/view.php
// At present this will only work for files that include config.php and are call
ed
// as part of the url (index.php is implied).
// Some examples are:
//      http://my.moodle.site/course/view.php
...
//      http://my.moodle.site/admin            (index.php implied)
// Custom scripts should not include config.php
// Warning: Replacing standard moodle scripts may pose security risks and/or may
 not
// be compatible with upgrades. Use this option only if you are aware of the ris
ks
// involved.
// Specify the full directory path to the custom scripts
//      $CFG->customscripts = '/home/example/customscripts';
...
/var/www/html/install/lang/ja/install.php
/var/www/html/install/lang/mi_wwow/install.php
/var/www/html/install/lang/uz/install.php
/var/www/html/install/lang/az/install.php
/var/www/html/enrol/self/db/install.php
/var/www/html/enrol/flatfile/db/install.php
/var/www/html/enrol/meta/db/install.php
/var/www/html/enrol/imsenterprise/db/install.php
/var/www/html/enrol/database/db/install.php
/var/www/html/enrol/manual/db/install.php
/var/www/html/enrol/ldap/db/install.php
/var/www/html/enrol/category/db/install.php
/var/www/html/report/outline/db/install.php
/var/www/html/report/progress/db/install.php
/var/www/html/report/completion/db/install.php
/var/www/html/report/stats/db/install.php
/var/www/html/report/log/db/install.php
/var/www/html/report/participation/db/install.php
root@4f313e644056:/# less /var/www/html/install
/var/www/html/install is a directory
root@4f313e644056:/# less /var/www/html/install
install/     install.php
root@4f313e644056:/# less /var/www/html/install.php
root@4f313e644056:/# less /var/www/html/config-dist.php
root@4f313e644056:/# cat /var/www/html/config-dist.php
<?php
///////////////////////////////////////////////////////////////////////////
//                                                                       //
// Moodle configuration file                                             //
